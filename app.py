...
def chat():
    ...
    if is_greeting(user_message):
        reply = "Halo! 👋 Saya Asisten AI dari Trisakti School of Multimedia. Silakan ajukan pertanyaan seputar pendidikan atau kampus kami."
    ...
    if program:
        prompt = (
            ...
            f"Berikan penjelasan lengkap dan menarik tentang program studi {program['name']}. "
